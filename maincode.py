...
class IMG_Stegno:
    ...
    #crypto- main frame or start page
    def main(self, root):
        ...
        encode.config(font=('Comic Sans MS',14), bg='#e8c1c7')
        encode.grid(row=2)
    ...
    #crypto - back function to loop back to main screen
    def back(self,frame):
        frame.destroy()
        self.main(root)

    
    #crypto - frame for encode page
    ...
    #crypto- function to encode image 
    ...
    #crypto - function to decode image 
    ...
    #crypto - function to decode data
    ...
    #crypto - function to generate data
    ...
    #crypto - function to modify the pixels of image
    ...
    #crypto - function to enter the data pixels in image
    ...
    #crypto - function to enter hidden text
